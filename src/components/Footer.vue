  ...
  <footer class="bg-white dark:bg-gray-800 w-full py-8">
    <div class="max-w-screen-xl mx-auto px-4">
      ...
      <div class="pt-8 flex max-w-xs mx-auto items-center justify-between">
        <a href="#" class="text-gray-400 hover:text-gray-500 dark:hover:text-white transition-colors duration-200">
        ...
        <a href="#" class="text-gray-400 hover:text-gray-500 dark:hover:text-white transition-colors duration-200">
          <svg width="24" height="24" fill="currentColor"
            class="text-xl hover:text-gray-800 dark:hover:text-white transition-colors duration-200" viewBox="0 0 24 24"
